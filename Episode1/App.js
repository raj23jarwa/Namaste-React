...
import Logo from '../Episode1/assets/images/logo.jpg'
import resLogo from '../Episode1/assets/images/resLogo.jpg'
const Header = () => {
    return (
...
const ResturantCard =({
    cloudinaryImageId,
    cuisines,name,area,lastMileTravelString,costForTwoString,avgRating
}) =>{
    return(
        <div className="resCard" style={resStyle}>
         <img src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId} alt="resLogo"></img>
            <h3> {name}</h3>
            <h4>{area}</h4>
            <h4> {cuisines.join(", ")} </h4>
            <span>
        ...
        <div className="Body">
            <div className="Search"> Search ..
                <div className="resContainer">
                    {/* <ResturantCard resName="Meghana Foods" cuisines= "Biryani, North India, Asian" rating = "4.3 star"/>
                    <ResturantCard resName= "KFC"  cuisines= "Burger, North India, Chinese" rating= "4.2 star" /> */}
